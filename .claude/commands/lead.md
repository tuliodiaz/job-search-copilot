...
## What it does
Hands off to the **capture-posting** skill, which fetches (or reads) the posting, **scans it on
...
## Notes
- This command only routes; the mechanics and the fail-closed handling live in the skill.
